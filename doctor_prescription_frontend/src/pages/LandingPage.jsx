...
const LandingPage = () => {
  ...
  // States for the Database and Filtering
  const [dbDoctors, setDbDoctors] = useState([]);
  const [activeFilter, setActiveFilter] = useState("All Specialists"); // This controls the active button tab

  // States for the Hero Search Bar
  ...
  // The Smart Filtering Logic (Combines the Search text and the Category filter)
  ...
  // Function triggered by the Hero Search button
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans transition-colors duration-300 scroll-smooth">
      {/* Navigation */}
      <nav className="bg-white dark:bg-gray-800 px-6 py-4 flex justify-between items-center fixed w-full z-50 shadow-sm transition-colors duration-300">
        <div
            ...
            <div className="absolute top-full left-0 mt-1 w-48 bg-white dark:bg-gray-800 shadow-xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex flex-col overflow-hidden border border-gray-100 dark:border-gray-700">
              {specialtiesList.slice(1).map((spec) => (
                <span
                  ...
                  className="px-4 py-3 hover:bg-primary/10 hover:text-primary transition-colors border-b border-gray-50 dark:border-gray-700">
                  {spec}
                </span>
              ))}
            </div>
      ...
      {/* Hero Section */}
      <div className="relative pt-32 pb-20 px-6 lg:px-20 bg-gradient-to-br from-primary-light/20 to-white dark:from-gray-800 dark:to-gray-900 overflow-hidden transition-colors duration-300">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
          ...
          <div className="w-full md:w-1/2 mt-10 md:mt-0 relative group">
            ...
            <img
              ...
              alt="Eye examination"
              className="rounded-3xl shadow-xl object-cover h-[400px] w-full relative z-10 transform transition-transform duration-500 group-hover:-translate-y-2"
            />
          </div>
        </div>

        {/* Floating Search Bar (Now Functional) */}
        <div className="max-w-6xl mx-auto mt-16 bg-white dark:bg-gray-800 rounded-full shadow-xl p-2 flex flex-col md:flex-row items-center divide-y md:divide-y-0 md:divide-x border border-gray-100 dark:border-gray-700 relative z-20">
          {/* Text Input */}
          ...
          <div
            ...
            <div
              className="flex items-center px-4 py-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors h-full"
              onClick={() =>
              ...
              <div className="absolute top-full left-0 mt-2 w-full bg-white dark:bg-gray-800 shadow-xl rounded-xl z-50 border border-gray-100 dark:border-gray-700 overflow-hidden">
                {specialtiesList.map((spec) => (
                  <div
                    ...
                    className="px-4 py-3 hover:bg-primary/10 hover:text-primary cursor-pointer transition-colors border-b border-gray-50 dark:border-gray-700 last:border-0 text-gray-700 dark:text-gray-300">
                    {spec}
                  </div>
                ))}
              </div>
          ...
          <div className="px-2 w-full md:w-auto mt-2 md:mt-0">
            <button
              ...
              className="w-full md:w-auto bg-primary text-white px-10 py-3.5 rounded-full font-semibold hover:bg-primary-dark hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2">
      ...
      <div
        className="bg-white dark:bg-gray-800 py-20 transition-colors duration-300"
        id="how-it-works">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20" id="doctors">
        <div className="flex justify-between items-end mb-8">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white">
            Featured Specialists
          </h2>
          <button className="text-primary font-medium hover:text-primary-dark flex items-center gap-2 border border-primary/30 hover:border-primary rounded-full px-6 py-2 transition-all duration-300 hover:shadow-md">
            View all →
          </button>
        </div>
          ...
          {specialtiesList.map((filter) => (
            <button
              ...
              onClick={() => {
                ...
                setSearchSpecialty(filter); // Keep hero search dropdown in sync
              }}
      ...
      <div
        ...
        id="reviews">
        {/* ... (Keeping the rest of the sections identical to previous step) ... */}
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-gray-800 text-sm text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
